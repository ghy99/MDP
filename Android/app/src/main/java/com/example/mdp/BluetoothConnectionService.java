...
public class BluetoothConnectionService {
    ...
    private static final String appName = "MDP_Group_45";
    ...
    private class ConnectThread extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                try {
                    Bluetooth mBluetoothActivity = (Bluetooth) mContext;
                    mBluetoothActivity.runOnUiThread(() -> Toast.makeText(mContext, "Failed to connect to the Device.", Toast.LENGTH_LONG).show());
                } catch (Exception z) {
                    z.printStackTrace();
                }
