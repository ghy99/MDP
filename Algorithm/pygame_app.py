...
#         text = font.render("Calculating path...", True, constants.WHITE)
#         text_rect = text.get_rect()
#         text_rect.center = constants.WINDOW_SIZE[0] / 2, constants.WINDOW_SIZE[1] / 2
...
#                     self.print_caption("Initialise World 6")
#                     self.obstacles = preGrid.getObsWorld(6)
#                     obs = self.parse_obstacle_data()
#                     self.grid = Grid(obs)
#                     self.robot = Robot(self.grid)
#                 elif event.key == pygame.K_7:
#                     self.print_caption("Initialise World 7")
#                     self.obstacles = preGrid.getObsWorld(7)
#                     obs = self.parse_obstacle_data()
#                     self.grid = Grid(obs)
#                     self.robot = Robot(self.grid)
...
#             self.render()
#
#             self.clock.tick(constants.FRAMES)
#
#         # pygame.quit()
#         # exit()
